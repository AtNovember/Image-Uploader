	...
	$('#upload-button .upload').click(function() {
		...
		$.each(dataArray, function(index, file) {	
			...
			$.post('upload.php', dataArray[index], function(data) {
				...
				var fileName = data.link + data.name;
				...
				if(totalPercent*(x) == 100) {
					...
					$('#uploaded-files').append('<li><a href="'+fileName+'">'+data.name+'</a> загружен успешно</li>');
					$('#uploaded-files').append('<li>URL:  <input value="'+ fileName +'"></input></li>');
					$('#uploaded-files').append('<li>Preview with increasing [BB]: <input value="'+ data.PreviewBB +'"></input></li>');
					$('#uploaded-files').append('<li>Preview with increasing [HTML]: <input value="'+ data.PreviewHTML +'"></input></li>');
					$('#uploaded-files').append('<li>Direct link: <input value="'+ data.directLink +'"></input></li>');
					$('#uploaded-files').append('<li>Image [BB]: <input value="'+ data.imageBB +'"></input></li>');
					$('#uploaded-files').append('<li>Image [HTML]: <input value="'+ data.imageHTML +'"></input></li>');
				...
				if(dataSplit == 'загружен успешно') {
					$('#uploaded-files').append('<li><a href="'+fileName+'">'+data.name+'</a> загружен успешно</li>');	
				} else {
					$('#uploaded-files').append('<li><a href="'+fileName+'. Имя файла: '+data.name+'</li>');
				}*/
